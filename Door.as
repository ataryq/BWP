package  {
	...
	public class Door extends MovieClip {
		...
		public static const Name:String = "door";
		protected var info:informBlockListPlatform;
		public var body:b2Body;
		
		public function Door(color:Number, withoutBody:Boolean = false, loc:Point = null) {
			// constructor code
			if(color > 0 && color < 5) {
		...
		protected function addStage(event:Event = null):void
		{
			...
			body = info.createWorld.createStaticBox(this.x, this.y, 70, 70);
